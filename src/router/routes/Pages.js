...
const PagesRoutes = [
  {
    path: "/cms/form-reset-password",
    component: lazy(
      () => import("../../views/pages/form-template/template-reset-password")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
